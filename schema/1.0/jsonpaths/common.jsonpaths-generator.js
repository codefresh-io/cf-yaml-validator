...
class CommonJSONPathsGenerator {
    constructor({ fieldType, joiSchemaDescription, isCamelCase } = {}) {
        this._fieldType = fieldType;
        this._joiSchemaDescription = joiSchemaDescription;
        this._isCamelCase = isCamelCase ?? false;
